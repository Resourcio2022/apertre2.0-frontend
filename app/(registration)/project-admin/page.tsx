...
const page = () => {
    ...
    const additionalInputGroups = [
        {
            fields: [
                { name: "repoName", type: "text", placeholder: "Repository name*", required: true },
                { name: "projectDomain", type: "select", placeholder: "Project domain*", required: true, component: ProjectDomain },
            ] as InputField[],
        },
        {
            fields: [
                { name: "repoURL", type: "url", placeholder: "Repository URL*", required: true },
            ] as InputField[],
        },
        {
            fields: [
        ...
        {
            fields: [
                { name: "techstack", type: "combobox", placeholder: "Tech stacks*", required: true, component: TechStacks },
            ] as InputField[],
        },
    ];

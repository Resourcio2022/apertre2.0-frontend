                    ...
                    <div className="text-lg md:text-2xl font-medium flex flex-col gap-6">
                        <div className="flex gap-2">
                            <Image
                                ...
                                height={30}
                            />
                            <p className="mt-1">3RD MARCH - 3RD APRIL</p>
                        </div>
                        <Link
                            href="#"
                            className="bg-[rgba(128,0,128,0.2)] text-textyellow font-medium px-4 py-3 rounded-xl border border-customYellow hover:bg-yellow-100/10 transition-colors duration-300 w-fit"
                        >
                            REGISTER
                        </Link>
                    </div>

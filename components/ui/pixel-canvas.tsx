...
const PixelCanvasComponent = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
...
PixelCanvasComponent.displayName = "PixelCanvas";

const PixelCanvas = dynamic(() => Promise.resolve(PixelCanvasComponent), {
  ssr: false
});
